...
train_Y = sys.argv[4]
test_X = sys.argv[1]
X_all_c, Y_all, X_test_c = load_data(train_X, train_Y, test_X,clf_col)
X_all_r, Y_all, X_test_r = load_data(train_X, train_Y, test_X,reg_col)
X_all_co, Y_all, X_test_co = load_data(train_X, train_Y, test_X,clf_colo)
X_all_ro, Y_all, X_test_ro = load_data(train_X, train_Y, test_X,reg_colo)
